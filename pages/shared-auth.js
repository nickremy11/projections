...
(function () {
  ...
  // The API worker lives on helper.ffhistorian.com. Only that host serves /api
  // locally; every other host (apex, projections subdomain, localhost) must call
  // it cross-origin.
  var _apiBase  = (location.hostname === 'helper.ffhistorian.com') ? '/api' : 'https://helper.ffhistorian.com/api';
  var _user     = null;
    ...
    if (_user) {
      ...
      container.innerHTML =
        '<span class="sh-chip sh-signed-in">' +
          ...
          '<a href="https://helper.ffhistorian.com/myprofile" class="sh-profile-link">View my profile</a>' +
